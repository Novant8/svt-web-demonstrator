        ...
        <Container>
          ...
          <BSNavbar.Collapse id="navbar-collapse">
            <Nav className="me-auto">
              {isLogged && (
                <>
                  <Nav.Link as={NavLink} to="/front">
                    Front-office
                  </Nav.Link>
                  <Nav.Link as={NavLink} to="/back">
                    Back-office
                  </Nav.Link>
                </>
              )}
            ...
            {userError ? (
              <span className="text-danger">Cannot fetch user!</span>
            ) : loadingUser ? (
              <UserPlaceholder />
            ) : isLogged ? (
              <>
                <span className="d-inline-block text-light me-2">
                  Hello, {user.name}
                  {isAdmin && (
                    <Badge pill bg="danger" as="small" className="mx-1">
                      Admin
                    </Badge>
                  )}
                  !
                ...
                {logoutError ? (
                  <span className="text-danger">{logoutError}</span>
                ) : (
                  <Button
                    variant="danger"
              ...
              <>
                ...
                <Button
                  ...
                  state={{ prevLocation: location }}
                >
                  <LoginIcon className="mb-1" /> Sign Up 
                </Button>
              </>
            )}
          </BSNavbar.Collapse>
